...
L["Adds an arrow in front of the chat lines to copy the entire line."] = "Tum satiri kopyalamak icin sohbet satirlarinin onune bir ok ekler."
...
L["This section will help reset specific settings back to default."] = "Bu bolum, belirli ayarlari varsayilana dondurmeye yardimci olacaktir."
...
L["Wiki:"] = true
L["Will attempt to sell another item in set interval after the previous one was sold."] = "Bir onceki urun satildiktan sonra belirlenen aralikta baska bir urun satmaya calisir."
L["Will display mana when the main power is:"] = "Ana guc, secili olan dolduktan sonra manayı gosterecek:"
...
L["|cffFF3333Note:|r Click the arrow on the dropdown box to see a list of spells."] = "|cffFF3333Not:|r Buyulerin listesini gormek icin acilir kutudaki oka tiklayin."
L["2D"] = true
L["3D"] = true
