...
L["*%s|r|cFFffffff below.  Made with|r |cFFff75dd<3|r |cFFffffffby the Tukui Community.|r"] = "*%s|r |cFFffffff該插件由 Tukui 社區共建, 為|cFFff75dd愛|r|cFFffffff而生.|r"
...
L["Add an aura to the filter. Aura IDs can be acquired using the tooltip to find the correct ID."] = "將光環添加到過濾器中. 光環 ID 可以通過浮動提示獲取正確的 ID."
...
L["Aura Indicator (Class)"] = "光環指示器 (職業)"
L["Aura Indicator (Global)"] = "光環指示器 (全局)"
L["Aura Indicator (Pet)"] = "光環指示器 (寵物)"
L["Aura Indicator (Profile)"] = "光環指示器 (設定檔)"
L["AuraBar Colors"] = "光環條顏色"
L["Auras"] = true
L["Auras displayed on Blizzard's raid frames."] = "顯示在暴雪團隊框架上的光環."
L["Auras you can dispel."] = "你可以驅散的光環."
L["Auto Add New Spells"] = "自動添加新法術"
L["Auto Deposit Reagents"] = "自動存放材料"
L["Auto Hide"] = "自動隱藏"
L["Auto Repair"] = "自動修裝"
...
L["BG Map"] = "戰場地圖"
L["BG Score"] = "戰場計分板"
L["Big Defensive"] = "防御大决"
L["Bind on Equip/Use Text"] = "裝備/使用時綁定的快捷鍵文字"
L["Blacklist"] = "黑名單"
...
L["Checked: Holding Alt will focus arrow keys to the editbox.\nNot holding Alt will let you move the character even while editbox is open.\n\nUnchecked: Arrow keys always focused to editbox when open."] = "選中: 按住 Alt 鍵時, 方向鍵將被輸入框捕獲. 不按住 Alt 鍵時, 即使輸入框打開, 你也可以使用方向鍵移動角色.\n\n未選中: 輸入框打開時, 方向鍵總是被輸入框捕獲."
...
L["Color health by amount remaining."] = "按剩餘數值顯示生命顏色."
L["Color health by classcolor or reaction."] = "以職業色或聲望為生命上色."
L["Color health by color selection."] = "以狀態選擇為生命上色."
...
L["Color power by classcolor or reaction."] = "以職業色或聲望為能量上色."
L["Color power by color selection."] = "以狀態選擇為能量上色."
L["Color Score"] = "彩色分數"
...
L["Defensives that are self cast."] = "自身施放的防御性技能."
L["Defensives that can be cast on others."] = "可施放在他人身上的防御性技能."
...
L["Desaturate"] = "變灰"
L["Desaturate Cooldowns"] = "冷卻時變灰"
L["Desaturate Icon"] = "圖示變灰"
L["Desaturate Junk"] = "垃圾變灰"
L["Desaturate Voice Icons"] = "語音圖示變灰"
L["Desaturated Icon"] = "圖示變灰"
L["Descending"] = "降序"
...
L["Display Recent Ally icon after names in chat (excludes whispers and emotes)."] = "在聊天中顯示最近的盟友圖示 (不包括悄悄話和表情)."
...
L["List of spells that will show when using Blizzard's assisted highlighting."] = "使用暴雪的輔助醒目標示時顯示的法術列表."
...
L["Selection"] = "狀態選擇"
L["Selection Health"] = "狀態選擇生命條"
L["Selection Power"] = "狀態選擇能量條"
...
L["Set auras that are not from you to desaturated."] = "將非您施放的光環變灰."
...
L["Show Text"] = "顯示文字"
L["Show the castbar icon desaturated if a spell is not interruptible."] = "在法術不可被打斷時將顯示圖示變灰."
L["Show Title"] = "顯示稱號"
...
L["The charge cooldown text."] = "充能冷卻文字."
...
L["The loss of control cooldown text."] = "失去控制冷卻文字."
...
L["This option controls whether nameplates will follow the settings below.\n\n|cffff3333Note:|r This is an override to the Motion Type setting."] = "該選項控制姓名板是否遵循以下設置.\n\n|cffff3333注意:|r 這會覆蓋「排列方式」的設置."
L["This option controls whether nameplates will follow the visibility settings below.\n\n|cffff3333Note:|r This will be overridden by the Enemy Combat Toggle."] = "該選項控制姓名板是否遵循以下可見性設置.\n\n|cffff3333注意:|r 這將被「敵對戰鬥開關」覆蓋."
L["This option controls whether nameplates will follow the visibility settings below.\n\n|cffff3333Note:|r This will be overridden by the Friendly Combat Toggle."] = "該選項控制姓名板是否遵循以下可見性設置.\n\n|cffff3333注意:|r 這將被「友方戰鬥開關」覆蓋."
...
L["Tooltip gets anchored to bags when they are shown."] = "當背包顯示時將浮動提示錨定到背包."
...
L["Use classification color only in instances."] = "僅在副本中使用分類顏色."
...
L["Use this backdrop color for units that are dead or ghosts."] = "在死亡或靈魂狀態下使用該背景顏色."
...
L["Zero will inherit the unitframe general Multiplier. Disabling this override."] = "設置為 0 將繼承單位框體的通用乘數. 也就是禁用這個覆蓋."
L["Zone Button"] = "區域按鍵"
L["Zone Name"] = "地區名"
...
L["|cffFF3333Note:|r Click the arrow on the dropdown box to see a list of spells."] = "|cffFF3333注意:|r 點擊下拉選單中的箭頭來查看列表."
L["2D"] = "2D"
L["3D"] = "3D"
L["ACHIEVEMENTS"] = "成就"
...
L["ELVUI_CREDITS"] = "特別感謝以下人員, 他們通過測試、編碼以及捐贈来幫助我們維護這個插件."
