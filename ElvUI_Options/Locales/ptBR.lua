...
L["Adds an arrow in front of the chat lines to copy the entire line."] = "Adiciona uma seta à frente as linhas do bate-papo para copiar a linha inteira."
...
L["Checked: Holding Alt will focus arrow keys to the editbox.\nNot holding Alt will let you move the character even while editbox is open.\n\nUnchecked: Arrow keys always focused to editbox when open."] = "Marcado: Manter a tecla Alt pressionada focará as teclas de seta na caixa de edição.\nSem pressionar Alt, você poderá mover o caractere mesmo com a caixa de edição aberta.\n\nDesmarcado: As teclas de seta sempre estarão focadas na caixa de edição quando ela estiver aberta."
...
L["Cooldown & Duration"] = "Recarga e Duração"
...
L["Enemy Enabled"] = "Habilitado para Inimigo"
L["Enemy NPC"] = true
L["Enemy Spells"] = true
...
L["Enrage"] = true
L["Environment Conditions"] = "Condições Ambientais"
L["Equipped"] = "Equipado"
...
L["Fade out the tooltip when it disappears, instant otherwise. Cursor anchored tooltips are unaffected."] = "Desvanecer a dica quando ela desaparecer, será instântanea caso contrário. Dicas ancoras ao Cursor não são afetadas."
...
L["Friendly Enabled"] = "Habilitado para Amigo"
...
L["Stacking Enabled"] = "Empilhamento Habilitado"
...
L["This section will help reset specific settings back to default."] = "Esta seção irá ajudá-lo a resetar configurações específicas para o padrão."
...
L["Use Solo Color"] = "Usar Cor Solo"
L["Use solo threat color when not in a group."] = "Use a Cor Solo quando não estiver em um grupo."
...
L["Wiki:"] = true
L["Will attempt to sell another item in set interval after the previous one was sold."] = "Irá tentar vender outro item num intervalo definido após o anterior ter sido vendido."
L["Will display mana when the main power is:"] = "Irá mostrar mana quando o poder principal for:"
...
L["|cffFF3333Note:|r Click the arrow on the dropdown box to see a list of spells."] = "|cffFF3333Nota:|r Clique na seta na caixa de suspensão para ver a lista de feitiços."
L["2D"] = "2D"
L["3D"] = "3D"
